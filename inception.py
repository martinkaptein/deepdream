...
#///////////////////////////////////////////////////////////////////////////
#MAIN DEEPDREAM FUNCTION & SETTINGS
#///////////////////////////////////////////////////////////////////////////
...
#SELECT HERE THE FIRST LAYER (!) DREAM GUIDE IMAGE (RECOMMENDED 224x224)
guide = np.float32(PIL.Image.open('dream_guide/catprofile224x224.jpg'))

#Guide image goes through 'unguided' dream [comment to disable]
guide = deepdream(net, guide)

print 'Guide dream finished, now dreaming on guide'
