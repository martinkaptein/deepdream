# equal to script.py + try to change appearance
...
#///////////////////////////////////////////////////////////////
img = np.float32(PIL.Image.open('source_pictures/cloudsw500.jpg'))
#///////////////////////////////////////////////////////////////
...
for i in xrange(200):
    ...
    PIL.Image.fromarray(np.uint8(frame)).save("output/experimental%04d.jpg"%frame_i)
    #This helps get a better result:
    frame = np.float32(PIL.Image.open('output/experimental%04d.jpg'%frame_i))
