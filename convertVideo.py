...
import sys
#You will probably have to change this! This is unique to my install
...
#///////////////////////////////////////////////////////////////////////////
#TRY TO MAKE THE SETTINGS AS LIGHT AS POSSIBLE
#///////////////////////////////////////////////////////////////////////////
...
#////////////////////////////////////////////////////////////////////////////////////
#open first frame (%04d)
#////////////////////////////////////////////////////////////////////////////////////

img = np.float32(PIL.Image.open('source_pictures/video-frames-2/0001.jpg')) #SELECT SMALL IMAGE FOR PERFORMANCE!
framesum = 223 # @ e.g 25 fps
...
for i in xrange(framesum):
	# make deepdream of frame 5 times for clarity
	for x in xrange(5):
		frame = deepdream(net, frame)
    	PIL.Image.fromarray(np.uint8(frame)).save("framesOutput2/%04d.jpg"%frame_i)
        frame = np.float32(PIL.Image.open('framesOutput2/%04d.jpg'%frame_i))

	# save frame
	PIL.Image.fromarray(np.uint8(frame)).save("framesOutput2/%04d.jpg"%frame_i)
	# open next frame
	frame_i += 1
	frame = np.float32(PIL.Image.open('source_pictures/video-frames-2/%04d.jpg'%frame_i))
