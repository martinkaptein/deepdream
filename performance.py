...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#THIS SCRIPT HAS THE PURPOSE TO MAKE THE 'USUAL' DREAM (@script.py) FASTER (expiriment)
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
def make_step(net, step_size=1.6, end='inception_4c/output', jitter=0, clip=True, objective=objective_L2):
...
#///////////////////////////////////////////////////////////////
img = np.float32(PIL.Image.open('source_pictures/tesla.jpg'))
#///////////////////////////////////////////////////////////////


#GUIDE IMAGE = ORIGINAL IMAGE WITH 1 DREAM (later 2) 'ON IT' (>> this is an experiment for total performance increase)
guide = deepdream(net, img)

#debug

print 'Guide is ready, now dreaming on (dreamt) guide'
...
frame = img
counter = 0
for i in xrange(30): #change how many times you want to re-feed
